        ...
        <div className='flex flex-col md:flex-row bg-slate-200 justify-between p-4 w-full h-auto md:h-20'>
            <div className='flex items-center space-x-4'>
                ...
                <div>
                    ...
                    <p className='text-black font-quicksand text-sm'>Công ty chuyên xuất khẩu phân phối cà phê thô</p>
                </div>
            </div>
            <div className='hidden md:flex items-center mt-4 md:mt-0 mr-10'>
                ...
                />
                <button className='px-4 py-2 bg-slate-700 text-white rounded-r-full hover:bg-blue-700'>
                    Search
                </button>
            </div>
        </div>
